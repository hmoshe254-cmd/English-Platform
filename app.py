...
# تصميم إخفاء القطة والواجهة البيضاء
st.markdown("""
<style>
...
for item in filtered:
    st.markdown(f'<div class="sentence-card"><div class="eng-text">{item["english"]}</div><div class="ar-text">📖 {item["arabic"]}</div><div class="pron-text">🗣️ نطق: {item["pronunciation"]}</div></div>', unsafe_allow_html=True)
